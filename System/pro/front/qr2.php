...
if(isset($_POST['submit']) ) {
    ...
    $codeContents = 'mailto:'.$email.'?subject='.urlencode($fuel_type.$vehicle_no.$eli_week.$bal_week).'&body='.urlencode($email); 
                                    ...
                                    <div class="card-body card-block">
                                        ...
                                        <form action=" " method="POST">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" name="email" value="<?php echo $data['email'] ?>" class="form-control"><br><br>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <input type="submit" name="submit" value="Create QR" class="btn btn-primary submitBtn" style="width:20em; margin:0;" />
                                                <!--
