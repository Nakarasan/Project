    ...
    <div class="page-wrapper">
                ...
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li >
                            ...
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                <li >
                                    <a href="station_table_cus.php">Customer</a>
                                </li> 
                                
                                <li>
                                    <a href="station_table_fue.php">Fuel</a>
                                </li>
                                <li>
                                    <a href="station_table_ava.php">Availability</a>
                                </li>
                            </ul>
                        </li>
        ...
        <div class="page-container">
                            ...
                            <div class="header-button">
                                ...
                                <div class="account-wrap">
                                    <div class="account-item clearfix js-item-menu">
                                        ...
                                        <div class="content">
                                            <a class="js-acc-btn" href="#">Vishnu</a>
                                        </div>
                                        <div class="account-dropdown js-dropdown">
                                            <div class="info clearfix">
                                                ...
                                                <div class="content">
                                                    ...
                                                    <span class="email">vishnu@gmail.com</span>
                                                </div>
                                            </div>
            ...
            <H1>QR Scanner</H1>
                ...
                <div class="col-12 col-md-9">
                <a class="btn btn-secondary" style="width:210px; margin:5px 0;" href="">Read Barcode</a>
                </div>
