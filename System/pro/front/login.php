...
if(isset($_POST["Submit"]))
{
    ...
    if ($user == "krishzkara@gmail.com") {
        header("Location: index.php");
        exit();

    } else if ($user == "vishnu@gmail.com") {
        header("Location: user/station_dash.php");
        exit();

    } else if ($user == "jansan@gmail.com") {
                        ...
                        <div class="login-form">
                            <form action="" method="post">
                                <div class="form-group">
                                    ...
                                    <input class="au-input au-input--full" type="text" name="user" placeholder="Email">
                                </div>
                                <div class="form-group">
